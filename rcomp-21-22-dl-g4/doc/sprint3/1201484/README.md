RCOMP 2021-2022 Project - Sprint 3 - Member 1201484 folder
===========================================
(This folder is to be created/edited by the team member 1201461 only)

#### This is just an example for a team member with number 1201484 ####

### Each member should create a folder similar to this, matching his/her number. ###

The owner of this folder (member number 1201484) will commit here all the outcomes (results/artifacts/products)
...
Simulação completa elaborada para o edifício 2.
...
* De seguida fizemos o mesmo passo mudando os ips para os ips das vlans do edifício 2 e a respetiva wildcard com área 2.
...
## 5. DNS
* O DNS server(ns.building-2.rcomp-21-22-dl-g4) e o DNS domain name(building-2.rcomp-21-22-dl-g4) já tinham sido definidos na configuração do DHCP.
...
## 6. NAT
* Efetuámos os comandos que se encontram no ficheiro de configuração do router do building 2 para as portas especifícadas no enunciado, 80(HTTP), 443(HTTPS) e 53(DNS) para TCP e UDP.
